...
import importToBBDD from "./javascript/importToBBDD";
            ...
            {selectedTable && (
                <>
                    ...
                    >
                        ...
                        >
                            <button onClick={() => onInsertOne(selectedRows)}>
                                ➕ Insertar Fila
                            </button>
                            <button onClick={() => onDeleteRows(selectedRows)}>
                                🗑️ Borrar Fila
                            </button>
                            ...
                            <input
                                ...
                                style={{ display: "none" }}
                                onChange={(e) =>
                                    importToBBDD(e, selectedTable, () => {
                                        reloadGrid(selectedTable); // 🔹 recarga los datos desde la BBDD
                                    })
                                }
                            />
                        </div>
