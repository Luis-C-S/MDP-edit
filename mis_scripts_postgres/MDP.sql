...
CREATE TABLE mdp_producto.tb_mdp_producto (
	...
	nom_producto character varying(80) NOT NULL,
...
CREATE TABLE mdp_producto.tb_mdp_producto_familia (
	cod_producto_comercial character varying(10) NOT NULL,
	cod_familia numeric(10,0) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_producto_atributo (
	...
	fec_baja timestamp,
	num_digitos_cb numeric(2,0) NOT NULL,
	observ_cb character varying(255),
	...
	ent_orientativa_min numeric(2,0),
	ent_orientativa_max numeric(2,0),
	ent_comprometidos_min numeric(2,0),
	ent_comprometidos_max numeric(2,0),
	retraso_min numeric(2,0),
	retraso_max numeric(3,0),
	retraso_indemnizacion character varying(60),
	robo_min numeric(3,0),
	robo_max numeric(3,0),
	robo_indemnizacion character varying(60),
	deterioro_min numeric(2,0),
	deterioro_max numeric(3,0),
	deterioro_indemnizacion character varying(255),
	plazo_respuesta_max numeric(3,0),
	plazo_indemniza_max numeric(3,0),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	...
	CONSTRAINT ck_plazos_entrega CHECK (((ent_orientativa_min >= (0)::numeric) AND (ent_orientativa_max >= (0)::numeric) AND (ent_comprometidos_min >= (0)::numeric) AND (ent_comprometidos_max >= (0)::numeric))),
	CONSTRAINT ck_retrasos CHECK (((retraso_min IS NOT NULL) AND (retraso_max IS NOT NULL) AND ((retraso_min >= (0)::numeric) AND (retraso_max >= (0)::numeric)) AND (retraso_min <= retraso_max))),
	CONSTRAINT ck_robo CHECK (((robo_min IS NOT NULL) AND (robo_max IS NOT NULL) AND (robo_min <= robo_max) AND ((robo_min >= (0)::numeric) AND (robo_max >= (0)::numeric)))),
	CONSTRAINT ck_deterioro CHECK (((deterioro_min IS NOT NULL) AND (deterioro_max IS NOT NULL) AND ((deterioro_min >= (0)::numeric) AND (deterioro_max >= (0)::numeric)) AND (deterioro_min <= deterioro_max))),
	CONSTRAINT ck_plazos CHECK (((plazo_respuesta_max IS NOT NULL) AND (plazo_indemniza_max IS NOT NULL) AND ((plazo_respuesta_max >= (0)::numeric) AND (plazo_indemniza_max >= (0)::numeric)))),
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
	CONSTRAINT ck_num_digitos_cb CHECK ((num_digitos_cb >= (0)::numeric)),
	CONSTRAINT ck_ent_orientativa CHECK (((ent_orientativa_min <= ent_orientativa_max) AND ((ent_orientativa_min IS NOT NULL) AND (ent_orientativa_max IS NOT NULL)) AND ((ent_orientativa_min >= (0)::numeric) AND (ent_orientativa_max >= (0)::numeric)))),
	CONSTRAINT ck_ent_comprometida CHECK (((ent_comprometidos_min <= ent_comprometidos_max) AND ((ent_comprometidos_min IS NOT NULL) AND (ent_comprometidos_max IS NOT NULL)) AND ((ent_comprometidos_min >= (0)::numeric) AND (ent_comprometidos_max >= (0)::numeric)))),
...
CREATE TABLE mdp_producto.tb_mdp_medida (
	cod_medida character varying(5) NOT NULL,
	nom_medida character varying(60) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_idioma (
	cod_idioma character varying(3) NOT NULL,
	nom_idioma character varying(80) NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	cod_idioma_ref character varying(3),
	cod_idi_alpha2 character varying(2) GENERATED ALWAYS AS (CASE     WHEN (cod_idioma_ref IS NULL) THEN cod_idioma_alpha2     ELSE NULL::character varying END) STORED,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
...
CREATE TABLE mdp_producto.tb_mdp_va (
	cod_va character varying(7) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_producto_idioma (
	cod_producto_comercial character varying(10) NOT NULL,
	cod_modalidad character varying(6) NOT NULL,
	fec_alta timestamp NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	fec_baja timestamp,
	nom_comercial character varying(80) NOT NULL,
	desc_producto character varying(255),
	desc_producto_ext character varying(255),
	desc_factura character varying(255),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
...
CREATE TABLE mdp_producto.tb_mdp_ambito (
	...
	nom_ambito character varying(250) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_va_idioma (
	cod_va character varying(7) NOT NULL,
	cod_perfil numeric(2,0) NOT NULL,
	fec_alta timestamp NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	fec_baja timestamp NOT NULL,
	nom_va character varying(80) NOT NULL,
	desc_va character varying(255),
	desc_va_ext character varying(255),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
	CONSTRAINT ck_fec_baja CHECK ((fec_baja > fec_alta)),
...
CREATE TABLE mdp_producto.tb_mdp_producto_atributo_pais (
	...
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
	CONSTRAINT ck_importes CHECK (((importe_max >= (0)::numeric) AND (importe_min >= (0)::numeric) AND (importe_max >= importe_min))),
...
CREATE TABLE mdp_producto.tb_mdp_tam_simple (
	...
	CONSTRAINT ck_peso CHECK ((peso >= (0)::numeric)),
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_tam_simple_idioma (
	cod_tam_simple numeric(10,0) NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	nom_tam_simple character varying(60) NOT NULL,
	desc_tam character varying(255),
	desc_alto character varying(60) NOT NULL,
	desc_ancho character varying(60) NOT NULL,
	desc_largo character varying(60) NOT NULL,
	desc_peso character varying(60) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_va_restriccion (
	cod_va character varying(7) NOT NULL,
	cod_va_rest character varying(7) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_producto_perfil_franqueo (
	cod_producto_comercial character varying(10) NOT NULL,
	cod_franqueo character varying(10) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_empresa (
	cod_empresa numeric(4,0) NOT NULL,
	nom_empresa character varying(60),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
...
CREATE TABLE mdp_producto.tb_mdp_sistema (
	cod_sistema character varying(3) NOT NULL,
	nom_sistema character varying(60) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_canal (
	...
	nom_canal character varying(60) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_tipo_material (
	...
	nom_tipo_material character varying(20) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_entrega (
	cod_entrega numeric(2,0) NOT NULL,
...
CREATE TABLE mdp_producto.tb_mdp_va_restriccion_idioma (
	...
	cod_va_rest character varying(7) NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	desc_restriccion character varying(255) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_familia_idioma (
	cod_familia numeric(10,0) NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	nom_familia character varying(100) NOT NULL,
	desc_familia character varying(255),
	mas_info character varying(255),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_tipo_formato (
	cod_tipo_formato numeric(2,0) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_franja_horaria (
	cod_franja numeric(2,0) NOT NULL,
...
CREATE TABLE mdp_producto.tb_mdp_franja_horaria_idioma (
	cod_franja numeric(2,0) NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	nom_franja character varying(30) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_tramo_idioma (
	cod_tramo numeric(10,0) NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	nom_tramo character varying(50) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_entrega_idioma (
	cod_entrega numeric(2,0) NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	nom_entrega character varying(60) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_tipo_formato_idioma (
	cod_tipo_formato numeric(2,0) NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	nom_tipo_formato character varying(20) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_atributo_va (
	cod_atributo_va numeric(5,0) NOT NULL,
	tipo_atributo character varying(1) NOT NULL,
	tam_atributo numeric(3,0) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_tipo_atributo CHECK (((tipo_atributo)::text = ANY ((ARRAY['T'::character varying, 'B'::character varying, 'N'::character varying, 'F'::character varying, 'M'::character varying])::text[]))),
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_atributo_va_idioma (
	cod_atributo_va numeric(5,0) NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	nom_atributo_va character varying(60) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_documento (
	cod_documento numeric(2,0) NOT NULL,
...
CREATE TABLE mdp_producto.tb_mdp_documento_idioma (
	cod_documento numeric(2,0) NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	desc_documento character varying(120) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_promocion (
	cod_promocion numeric(10,0) NOT NULL,
	nom_promocion character varying(8) NOT NULL,
	desc_promocion character varying(255),
	ind_estado character varying(1) NOT NULL DEFAULT 'I',
	fec_inicio_promocion timestamp NOT NULL,
	fec_fin_promocion timestamp NOT NULL,
	cod_sistema character varying(3) NOT NULL,
	tipo_promocion character varying(2) NOT NULL,
	ind_promocion_envio boolean NOT NULL DEFAULT false,
	promocion_envio_aplicable character varying(1),
	importe_min numeric(10,0),
	importe_max numeric(10,0),
	ind_dto_modificable boolean NOT NULL DEFAULT false,
	ind_promocion_acumulable boolean NOT NULL DEFAULT false,
	min_productos numeric(10,0),
	max_productos numeric(10,0),
	tipo_descuento character varying(1) NOT NULL,
	importe_descuento numeric(7,2) NOT NULL,
	masc_ini_rango numeric(8,0),
	masc_fin_rango numeric(8,0),
	masc_num_usos numeric(8,0),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_estado CHECK (((ind_estado)::text = ANY ((ARRAY['I'::character varying, 'A'::character varying, 'P'::character varying])::text[]))),
	CONSTRAINT ck_fec_fin_promocion CHECK ((fec_fin_promocion >= fec_inicio_promocion)),
	CONSTRAINT ck_tipo_promocion CHECK (((tipo_promocion)::text = ANY ((ARRAY['MP'::character varying, 'AU'::character varying, 'CO'::character varying])::text[]))),
	CONSTRAINT ck_promocion_envio_aplicable CHECK (((promocion_envio_aplicable)::text = ANY ((ARRAY['P'::character varying, 'V'::character varying, 'C'::character varying])::text[]))),
	CONSTRAINT ck_precios CHECK (((importe_max >= importe_min) AND (importe_min >= (0)::numeric) AND (importe_max >= (0)::numeric))),
	CONSTRAINT ck_productos CHECK (((max_productos >= min_productos) AND (min_productos >= (0)::numeric) AND (max_productos >= (0)::numeric))),
	CONSTRAINT ck_tipo_descuento CHECK (((tipo_descuento)::text = ANY ((ARRAY['P'::character varying, 'F'::character varying, 'T'::character varying])::text[]))),
	CONSTRAINT ck_importe_descuento CHECK ((importe_descuento >= (0)::numeric)),
	CONSTRAINT ck_masc_rango CHECK (((masc_fin_rango >= masc_ini_rango) AND (masc_ini_rango >= (0)::numeric) AND (masc_fin_rango >= (0)::numeric))),
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
	CONSTRAINT ck_masc_num_usos CHECK ((((masc_num_usos IS NOT NULL) AND (masc_num_usos >= (0)::numeric)) OR (masc_num_usos IS NULL))),
...
CREATE TABLE mdp_producto.tb_mdp_promocion_codigo (
	cod_promocional character varying(20) NOT NULL,
	cod_promocion numeric(10,0) NOT NULL,
	num_usos numeric(8,0),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_num_usos CHECK ((num_usos >= (0)::numeric)),
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_promocion_oficina (
	cod_promo_oficina numeric(10,0) NOT NULL,
	cod_promocion numeric(10,0) NOT NULL,
	cod_zona numeric(2,0) NOT NULL,
	cod_sector numeric(4,0) NOT NULL,
	codired character varying(10) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
	CONSTRAINT ck_datos_oficina CHECK (((cod_zona >= (0)::numeric) AND (cod_sector >= (0)::numeric))),
...
CREATE TABLE mdp_producto.tb_mdp_zona_tarifaria (
	cod_zona_tarif character varying(10) NOT NULL,
	nom_zona_tarif character varying(60) NOT NULL,
	desc_zona_tarif character varying(600),
	cod_sap_destino character varying(4),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_producto_zona (
	...
	cod_ambito numeric(5,0) NOT NULL,
	cod_zona_tarif character varying(10) NOT NULL,
	cod_tasa_impositiva numeric(3,0) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_zona_tarif_provincia (
	cod_zona_tarif character varying(10) NOT NULL,
	cod_provincia_origen character varying(2) NOT NULL,
	cod_provincia_destino character varying(2) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_complemento (
	cod_complemento numeric(10,0) NOT NULL,
	desc_complemento character varying(255),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_va_perfil (
	...
	fec_alta timestamp NOT NULL,
	fec_baja timestamp,
	cod_sap character varying(18),
	importe_base numeric(7,2) NOT NULL,
	importe_min numeric(7,2) NOT NULL,
	por_incremento numeric(7,2) NOT NULL,
	valor_complejidad numeric(1,0),
	desc_precio_va character varying(255),
	cod_formula numeric(1,0) NOT NULL,
	desc_formula character varying(100) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
	CONSTRAINT ck_valor_complejidad CHECK ((valor_complejidad = ANY (ARRAY[(1)::numeric, (2)::numeric, (3)::numeric]))),
	CONSTRAINT ck_importe_base CHECK ((importe_base >= (0)::numeric)),
	CONSTRAINT ck_importe_min CHECK ((importe_min >= (0)::numeric)),
	CONSTRAINT ck_por_incremento CHECK ((por_incremento >= (0)::numeric)),
	CONSTRAINT ck_fecbaja CHECK (((fec_baja IS NULL) OR (fec_baja > fec_alta))),
	CONSTRAINT ck_formula CHECK (((cod_formula >= (1)::numeric) AND (cod_formula <= (6)::numeric))),
...
CREATE TABLE mdp_producto.tb_mdp_tipo_impuesto (
	cod_tipo_impuesto character varying(4) NOT NULL,
	nom_tipo_impuesto character varying(25) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_tipo_gravamen (
	cod_tipo_gravamen character varying(4) NOT NULL,
	nom_tipo_gravamen character varying(25) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_impuesto_gravamen (
	...
	cod_sap character varying(8),
	fec_inicio timestamp NOT NULL,
	fec_fin timestamp,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_fin CHECK (((fec_fin IS NULL) OR ((fec_fin IS NOT NULL) AND (fec_fin >= fec_inicio)))),
	CONSTRAINT ck_por_gravamen CHECK (((por_gravamen >= (0)::numeric) AND (por_gravamen <= (100)::numeric))),
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_ambito_detalle (
	cod_ambito_detalle numeric(5,0) NOT NULL,
	cod_ambito numeric(5,0) NOT NULL,
	cod_provincia character varying(2),
	cod_pais character varying(3),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_sobrecoste (
	cod_sobrecoste numeric(2,0) NOT NULL,
	desc_sobrecoste character varying(255),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_producto_sobrecoste (
	...
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
	CONSTRAINT ck_importe CHECK ((importe_fijo >= (0)::numeric)),
	CONSTRAINT ck_por_sobrecoste CHECK (((por_sobrecoste >= (0)::numeric) AND (por_sobrecoste <= (100)::numeric))),
...
CREATE TABLE mdp_producto.tb_mdp_zona_tarif_postal (
	cod_zona_tarif character varying(10) NOT NULL,
	cod_postal_origen character varying(10) NOT NULL,
	cod_postal_destino character varying(10) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_prefijo (
	cod_prod_prefijo character varying(2) NOT NULL,
	desc_prefijo character varying(120),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
-- object: mdp_producto.tb_mdp_clonar_id_seq | type: SEQUENCE --
-- DROP SEQUENCE IF EXISTS mdp_producto.tb_mdp_clonar_id_seq CASCADE;
CREATE SEQUENCE mdp_producto.tb_mdp_clonar_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START WITH 1
...
-- ddl-end --
ALTER SEQUENCE mdp_producto.tb_mdp_clonar_id_seq OWNER TO postgres;
-- ddl-end --
...
CREATE TABLE mdp_producto.tb_mdp_clonar (
	id integer NOT NULL DEFAULT nextval('mdp_producto.tb_mdp_clonar_id_seq'::regclass),
	cod_sistema_origen character varying(3) NOT NULL,
	cod_sistema_destino character varying(3),
	cod_producto_origen character varying(10),
	cod_producto_destino character varying(10),
	cod_zona_tarif character varying(10),
	por_tarifa numeric(5,2),
	fec_origen timestamp NOT NULL,
	fec_alta timestamp NOT NULL,
	fec_baja timestamp NOT NULL,
	tipo_clonacion numeric(1,0) NOT NULL,
	ind_porcentaje boolean NOT NULL,
	fec_creacion timestamp NOT NULL,
	CONSTRAINT ck_fechas CHECK ((fec_baja >= fec_alta)),
	CONSTRAINT ck_tipos CHECK ((tipo_clonacion = ANY (ARRAY[(1)::numeric, (2)::numeric, (3)::numeric]))),
...
CREATE TABLE mdp_producto.tb_mdp_perfil (
	cod_perfil numeric(2,0) NOT NULL,
	nom_perfil character varying(100) NOT NULL,
...
CREATE TABLE mdp_producto.tb_mdp_admision (
	cod_admision numeric(2,0) NOT NULL,
	ind_citypaq boolean NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_admision_idioma (
	cod_admision numeric(2,0) NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	nom_admision character varying(60) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_modalidad (
	cod_modalidad character varying(6) NOT NULL,
	cod_entrega numeric(2,0),
	cod_admision numeric(2,0),
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
CREATE TABLE mdp_producto.tb_mdp_producto_perfil_sistema (
	...
	cod_sistema character varying(3) NOT NULL,
	cod_modalidad character varying(6) NOT NULL,
	cuenta_cont numeric(20,0) NOT NULL,
...
CREATE TABLE mdp_producto.tb_mdp_trazabilidad_temperatura (
	cod_trazabilidad_temperatura numeric(2,0) NOT NULL,
	desc_trazabilidad_temperatura character varying(255) NOT NULL,
...
CREATE TABLE mdp_producto.tb_mdp_rango_temperatura (
	cod_rango_temperatura numeric(2,0) NOT NULL,
	desc_rango_temperatura character varying(255) NOT NULL,
...
CREATE TABLE mdp_producto.tb_mdp_tam_simple_sobrecoste (
	cod_tam_simple numeric(10,0) NOT NULL,
	cod_sobrecoste numeric(2,0) NOT NULL,
	exceso_simple numeric(2,0) NOT NULL,
	exceso_ampliado numeric(2,0) NOT NULL,
	exceso_peso_altura numeric(2,0) NOT NULL,
	coeficiente_ampliado numeric(4,2) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
	CONSTRAINT ck_excesos CHECK (((exceso_simple >= (0)::numeric) AND (exceso_ampliado >= (0)::numeric) AND (exceso_peso_altura >= (0)::numeric))),
	CONSTRAINT ck_coeficiente CHECK ((coeficiente_ampliado >= (0)::numeric)),
...
CREATE TABLE mdp_producto.tb_mdp_modalidad_idioma (
	cod_modalidad character varying(6) NOT NULL,
	cod_idioma_alpha2 character varying(2) NOT NULL,
	nom_modalidad character varying(60) NOT NULL,
	fec_creacion timestamp NOT NULL,
	fec_actualizacion timestamp NOT NULL,
	CONSTRAINT ck_fec_actualizacion CHECK ((fec_actualizacion >= fec_creacion)),
...
-- object: public.tb_mdp_admision | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_admision CASCADE;
CREATE TABLE public.tb_mdp_admision (
	cod_admision character varying(255),
	ind_citypaq character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_admision OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_admision_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_admision_idioma CASCADE;
CREATE TABLE public.tb_mdp_admision_idioma (
	cod_admision character varying(255),
	cod_idioma_alpha2 character varying(255),
	nom_admision character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_admision_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_ambito | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_ambito CASCADE;
CREATE TABLE public.tb_mdp_ambito (
	cod_ambito character varying(255),
	nom_ambito character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_ambito OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_ambito_detalle | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_ambito_detalle CASCADE;
CREATE TABLE public.tb_mdp_ambito_detalle (
	cod_ambito_detalle character varying(255),
	cod_ambito character varying(255),
...
-- ddl-end --
ALTER TABLE public.tb_mdp_ambito_detalle OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_ambito_perfil_modalidad | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_ambito_perfil_modalidad CASCADE;
CREATE TABLE public.tb_mdp_ambito_perfil_modalidad (
	cod_producto_comercial character varying(255),
	cod_modalidad character varying(255),
	fec_alta character varying(255),
	cod_ambito character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_ambito_perfil_modalidad OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_atributo_va | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_atributo_va CASCADE;
CREATE TABLE public.tb_mdp_atributo_va (
	cod_atributo_va character varying(255),
	tipo_atributo character varying(255),
	tam_atributo character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_atributo_va OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_atributo_va_documento | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_atributo_va_documento CASCADE;
CREATE TABLE public.tb_mdp_atributo_va_documento (
	cod_atributo_va character varying(255),
	cod_documento character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_atributo_va_documento OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_atributo_va_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_atributo_va_idioma CASCADE;
CREATE TABLE public.tb_mdp_atributo_va_idioma (
	cod_atributo_va character varying(255),
	cod_idioma_alpha2 character varying(255),
	nom_atributo_va character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_atributo_va_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_canal | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_canal CASCADE;
CREATE TABLE public.tb_mdp_canal (
	cod_canal character varying(255) NOT NULL,
	nom_canal character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255),
	CONSTRAINT tb_mdp_canal_pkey PRIMARY KEY (cod_canal)
);
-- ddl-end --
ALTER TABLE public.tb_mdp_canal OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_complemento | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_complemento CASCADE;
CREATE TABLE public.tb_mdp_complemento (
	cod_complemento character varying(255),
	desc_complemento character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_complemento OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_documento | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_documento CASCADE;
CREATE TABLE public.tb_mdp_documento (
	cod_documento character varying(255),
	ind_validacion character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_documento OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_documento_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_documento_idioma CASCADE;
CREATE TABLE public.tb_mdp_documento_idioma (
	cod_documento character varying(255),
	cod_idioma_alpha2 character varying(255),
	desc_documento character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_documento_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_empresa | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_empresa CASCADE;
CREATE TABLE public.tb_mdp_empresa (
	cod_empresa character varying(255),
	nom_empresa character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_empresa OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_entrega | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_entrega CASCADE;
CREATE TABLE public.tb_mdp_entrega (
	cod_entrega character varying(255),
	ind_citypaq character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_entrega OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_entrega_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_entrega_idioma CASCADE;
CREATE TABLE public.tb_mdp_entrega_idioma (
	cod_entrega character varying(255),
	cod_idioma_alpha2 character varying(255),
	nom_entrega character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_entrega_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_familia | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_familia CASCADE;
CREATE TABLE public.tb_mdp_familia (
	cod_familia character varying(255),
	logo character varying(255),
	cod_familia_padre character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_familia OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_familia_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_familia_idioma CASCADE;
CREATE TABLE public.tb_mdp_familia_idioma (
	cod_familia character varying(255),
	cod_idioma_alpha2 character varying(255),
	nom_familia character varying(255),
	desc_familia character varying(255),
	mas_info character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_familia_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_franja_horaria | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_franja_horaria CASCADE;
CREATE TABLE public.tb_mdp_franja_horaria (
	cod_franja character varying(255),
...
-- ddl-end --
ALTER TABLE public.tb_mdp_franja_horaria OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_franja_horaria_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_franja_horaria_idioma CASCADE;
CREATE TABLE public.tb_mdp_franja_horaria_idioma (
	cod_franja character varying(255),
	cod_idioma_alpha2 character varying(255),
	nom_franja character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_franja_horaria_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_idioma CASCADE;
CREATE TABLE public.tb_mdp_idioma (
	cod_idioma character varying(255),
	nom_idioma character varying(255),
	cod_idioma_alpha2 character varying(255),
	cod_idioma_ref character varying(255),
	cod_idi_alpha2 character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_impuesto_gravamen | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_impuesto_gravamen CASCADE;
CREATE TABLE public.tb_mdp_impuesto_gravamen (
	cod_tasa_impositiva character varying(255),
	cod_tipo_impuesto character varying(255),
	cod_tipo_gravamen character varying(255),
	por_gravamen character varying(255),
	cod_sap character varying(255),
	fec_inicio character varying(255),
	fec_fin character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_impuesto_gravamen OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_medida | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_medida CASCADE;
CREATE TABLE public.tb_mdp_medida (
	cod_medida character varying(255),
	nom_medida character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_medida OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_modalidad | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_modalidad CASCADE;
CREATE TABLE public.tb_mdp_modalidad (
	cod_modalidad character varying(255),
	cod_entrega character varying(255),
	cod_admision character varying(255),
	fec_creacion character varying(255),
...
-- ddl-end --
ALTER TABLE public.tb_mdp_modalidad OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_modalidad_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_modalidad_idioma CASCADE;
CREATE TABLE public.tb_mdp_modalidad_idioma (
	cod_modalidad character varying(255),
	cod_idioma_alpha2 character varying(255),
	nom_modalidad character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_modalidad_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_perfil | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_perfil CASCADE;
CREATE TABLE public.tb_mdp_perfil (
	cod_perfil character varying(255),
	nom_perfil character varying(255),
	ind_cliente_contrato character varying(255),
	ind_oferta_comercial character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_perfil OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_prefijo | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_prefijo CASCADE;
CREATE TABLE public.tb_mdp_prefijo (
	cod_prod_prefijo character varying(255),
	desc_prefijo character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_prefijo OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto CASCADE;
CREATE TABLE public.tb_mdp_producto (
	cod_producto character varying(255),
	nom_producto character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_atributo | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_atributo CASCADE;
CREATE TABLE public.tb_mdp_producto_atributo (
	cod_producto character varying(255),
	fec_alta character varying(255),
	fec_baja character varying(255),
	num_digitos_cb character varying(255),
	observ_cb character varying(255),
	paginas_min character varying(255),
	palabras_min character varying(255),
	ind_log_inversa character varying(255),
	cod_empresa character varying(255),
	ind_exento_aduana character varying(255),
	ind_spu character varying(255),
	ent_orientativa_min character varying(255),
	ent_orientativa_max character varying(255),
	ent_comprometidos_min character varying(255),
	ent_comprometidos_max character varying(255),
	retraso_min character varying(255),
	retraso_max character varying(255),
	retraso_indemnizacion character varying(255),
	deterioro_min character varying(255),
	deterioro_max character varying(255),
	deterioro_indemnizacion character varying(255),
	plazo_respuesta_max character varying(255),
	plazo_indemniza_max character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_atributo OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_atributo_pais | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_atributo_pais CASCADE;
CREATE TABLE public.tb_mdp_producto_atributo_pais (
	cod_producto_comercial character varying(255),
	cod_modalidad character varying(255),
	fec_alta character varying(255),
	cod_pais character varying(255),
	fec_baja character varying(255),
	ind_obliga_peso character varying(255),
	peso_min character varying(255),
	peso_max character varying(255),
	importe_min character varying(255),
	importe_max character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_atributo_pais OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_familia | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_familia CASCADE;
CREATE TABLE public.tb_mdp_producto_familia (
	cod_producto_comercial character varying(255),
	cod_familia character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_familia OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_idioma CASCADE;
CREATE TABLE public.tb_mdp_producto_idioma (
	cod_producto_comercial character varying(255),
	cod_modalidad character varying(255),
	fec_alta character varying(255),
	cod_idioma_alpha2 character varying(255),
	fec_baja character varying(255),
	nom_comercial character varying(255),
	desc_producto character varying(255),
	desc_producto_ext character varying(255),
	desc_factura character varying(255),
	fec_creacion character varying(255),
...
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_material | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_material CASCADE;
CREATE TABLE public.tb_mdp_producto_material (
	cod_producto_comercial character varying(255),
	cod_tipo_material character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_material OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_perfil | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_perfil CASCADE;
CREATE TABLE public.tb_mdp_producto_perfil (
	cod_producto_comercial character varying(255),
	cod_producto character varying(255),
	cod_perfil character varying(255),
	ind_imei character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_perfil OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_perfil_franqueo | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_perfil_franqueo CASCADE;
CREATE TABLE public.tb_mdp_producto_perfil_franqueo (
	cod_producto_comercial character varying(255),
	cod_franqueo character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_perfil_franqueo OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_perfil_modalidad | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_perfil_modalidad CASCADE;
CREATE TABLE public.tb_mdp_producto_perfil_modalidad (
	cod_producto_comercial character varying(255),
	cod_modalidad character varying(255),
	fec_alta character varying(255),
	fec_baja character varying(255),
	cod_sap character varying(255),
	cod_upu character varying(255),
	ind_obliga_cb character varying(255),
	num_intentos_entrega character varying(255),
	num_bultos_max character varying(255),
	logo character varying(255),
	ind_obliga_medidas character varying(255),
	largo_min character varying(255),
	largo_max character varying(255),
	largo_extra_max character varying(255),
	ancho_min character varying(255),
	ancho_max character varying(255),
	ancho_extra_max character varying(255),
	alto_min character varying(255),
	alto_max character varying(255),
	alto_extra_max character varying(255),
	criterio_max character varying(255),
	criterio_extra character varying(255),
	dimension_rollo_min character varying(255),
	dimension_rollo_max character varying(255),
	diametro_min character varying(255),
	diametro_max character varying(255),
	criterio_rollo_max character varying(255),
	peso_volumetrico_max character varying(255),
	volumen character varying(255),
	caducidad_min character varying(255),
	caducidad_max character varying(255),
	tiempo_lista character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_perfil_modalidad OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_perfil_sistema | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_perfil_sistema CASCADE;
CREATE TABLE public.tb_mdp_producto_perfil_sistema (
	cod_producto_comercial character varying(255),
	cod_sistema character varying(255),
	cod_modalidad character varying(255),
	cuenta_cont character varying(255),
	fec_inicio_destacado character varying(255),
	fec_fin_destacado character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_perfil_sistema OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_rango_temperatura | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_rango_temperatura CASCADE;
CREATE TABLE public.tb_mdp_producto_rango_temperatura (
	cod_producto_comercial character varying(255),
	cod_rango_temperatura character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_rango_temperatura OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_sistema_prefijo | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_sistema_prefijo CASCADE;
CREATE TABLE public.tb_mdp_producto_sistema_prefijo (
	cod_prod_prefijo character varying(255),
	cod_producto character varying(255),
	cod_sistema character varying(255),
	cod_modalidad character varying(255),
	ind_valor_declarado character varying(255),
	ind_entrega_recogida character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_sistema_prefijo OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_sobrecoste | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_sobrecoste CASCADE;
CREATE TABLE public.tb_mdp_producto_sobrecoste (
	cod_producto_comercial character varying(255),
	cod_modalidad character varying(255),
	fec_alta character varying(255),
	cod_sobrecoste character varying(255),
	importe_fijo character varying(255),
	por_sobrecoste character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_sobrecoste OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_tam_simple | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_tam_simple CASCADE;
CREATE TABLE public.tb_mdp_producto_tam_simple (
	cod_producto_comercial character varying(255),
	cod_modalidad character varying(255),
	fec_alta character varying(255),
	cod_tam_simple character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_tam_simple OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_tipo | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_tipo CASCADE;
CREATE TABLE public.tb_mdp_producto_tipo (
	cod_producto_comercial character varying(255),
...
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_tipo OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_tipo_formato | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_tipo_formato CASCADE;
CREATE TABLE public.tb_mdp_producto_tipo_formato (
	cod_producto character varying(255),
	cod_tipo_formato character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_tipo_formato OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_trazabilidad_temperatura | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_trazabilidad_temperatura CASCADE;
CREATE TABLE public.tb_mdp_producto_trazabilidad_temperatura (
	cod_producto_comercial character varying(255),
	cod_trazabilidad_temperatura character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_trazabilidad_temperatura OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_va | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_va CASCADE;
CREATE TABLE public.tb_mdp_producto_va (
	cod_producto_comercial character varying(255),
	cod_modalidad character varying(255),
	fec_alta character varying(255),
	cod_va character varying(255),
	cod_pais character varying(255),
	fec_baja character varying(255),
	ind_obligatorio character varying(255),
	cod_grp_va_obligatorio character varying(255),
	tipo_emb character varying(255),
	num_intentos_entrega_min character varying(255),
	num_intentos_entrega_max character varying(255),
	tiempo_lista_min character varying(255),
	tiempo_lista_max character varying(255),
	importe_min character varying(255),
	importe_max character varying(255),
	tiempo_custodia character varying(255),
	ind_envio character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_va OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_producto_zona | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_producto_zona CASCADE;
CREATE TABLE public.tb_mdp_producto_zona (
	cod_producto_comercial character varying(255),
	cod_modalidad character varying(255),
	fec_alta character varying(255),
	cod_ambito character varying(255),
	cod_zona_tarif character varying(255),
	cod_tasa_impositiva character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_producto_zona OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_rango_temperatura | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_rango_temperatura CASCADE;
CREATE TABLE public.tb_mdp_rango_temperatura (
	cod_rango_temperatura character varying(255),
	desc_rango_temperatura character varying(255),
	temperatura_min character varying(255),
	temperatura_max character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_rango_temperatura OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_sistema | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_sistema CASCADE;
CREATE TABLE public.tb_mdp_sistema (
	cod_sistema character varying(255),
	nom_sistema character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_sistema OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_sistema_canal | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_sistema_canal CASCADE;
CREATE TABLE public.tb_mdp_sistema_canal (
	cod_sistema character varying(255),
	cod_canal character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_sistema_canal OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_sobrecoste | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_sobrecoste CASCADE;
CREATE TABLE public.tb_mdp_sobrecoste (
	cod_sobrecoste character varying(255),
	desc_sobrecoste character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_sobrecoste OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_tam_simple | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_tam_simple CASCADE;
CREATE TABLE public.tb_mdp_tam_simple (
	cod_tam_simple character varying(255),
	largo character varying(255),
	alto character varying(255),
	ancho character varying(255),
	peso character varying(255),
	logo_tam_simple character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_tam_simple OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_tam_simple_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_tam_simple_idioma CASCADE;
CREATE TABLE public.tb_mdp_tam_simple_idioma (
	cod_tam_simple character varying(255),
	cod_idioma_alpha2 character varying(255),
	nom_tam_simple character varying(255),
	desc_tam character varying(255),
	desc_alto character varying(255),
	desc_ancho character varying(255),
	desc_largo character varying(255),
	desc_peso character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_tam_simple_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_tam_simple_sobrecoste | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_tam_simple_sobrecoste CASCADE;
CREATE TABLE public.tb_mdp_tam_simple_sobrecoste (
	cod_tam_simple character varying(255),
	cod_sobrecoste character varying(255),
	exceso_simple character varying(255),
	exceso_ampliado character varying(255),
	exceso_peso_altura character varying(255),
	coeficiente_ampliado character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_tam_simple_sobrecoste OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_tipo | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_tipo CASCADE;
CREATE TABLE public.tb_mdp_tipo (
	cod_tipo character varying(255),
...
-- ddl-end --
ALTER TABLE public.tb_mdp_tipo OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_tipo_formato | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_tipo_formato CASCADE;
CREATE TABLE public.tb_mdp_tipo_formato (
	cod_tipo_formato character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_tipo_formato OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_tipo_formato_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_tipo_formato_idioma CASCADE;
CREATE TABLE public.tb_mdp_tipo_formato_idioma (
	cod_tipo_formato character varying(255),
	cod_idioma_alpha2 character varying(255),
	nom_tipo_formato character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_tipo_formato_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_tipo_gravamen | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_tipo_gravamen CASCADE;
CREATE TABLE public.tb_mdp_tipo_gravamen (
	cod_tipo_gravamen character varying(255),
	nom_tipo_gravamen character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_tipo_gravamen OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_tipo_impuesto | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_tipo_impuesto CASCADE;
CREATE TABLE public.tb_mdp_tipo_impuesto (
	cod_tipo_impuesto character varying(255),
	nom_tipo_impuesto character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_tipo_impuesto OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_tipo_material | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_tipo_material CASCADE;
CREATE TABLE public.tb_mdp_tipo_material (
	cod_tipo_material character varying(255),
	nom_tipo_material character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_tipo_material OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_tramo | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_tramo CASCADE;
CREATE TABLE public.tb_mdp_tramo (
	cod_tramo character varying(255),
	limite_min character varying(255),
	limite_max character varying(255),
	cod_medida character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_tramo OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_tramo_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_tramo_idioma CASCADE;
CREATE TABLE public.tb_mdp_tramo_idioma (
	cod_tramo character varying(255),
	cod_idioma_alpha2 character varying(255),
	nom_tramo character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_tramo_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_trazabilidad_temperatura | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_trazabilidad_temperatura CASCADE;
CREATE TABLE public.tb_mdp_trazabilidad_temperatura (
	cod_trazabilidad_temperatura character varying(255),
	desc_trazabilidad_temperatura character varying(255),
	ind_datalogger character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_trazabilidad_temperatura OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_va | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_va CASCADE;
CREATE TABLE public.tb_mdp_va (
	cod_va character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_va OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_va_atributo_va | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_va_atributo_va CASCADE;
CREATE TABLE public.tb_mdp_va_atributo_va (
	cod_va character varying(255),
	cod_atributo_va character varying(255),
	ind_obligatorio character varying(255),
	fec_creacion character varying(255),
...
-- ddl-end --
ALTER TABLE public.tb_mdp_va_atributo_va OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_va_franja_horaria | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_va_franja_horaria CASCADE;
CREATE TABLE public.tb_mdp_va_franja_horaria (
	cod_va character varying(255),
	cod_perfil character varying(255),
	fec_alta character varying(255),
	cod_franja character varying(255),
...
-- ddl-end --
ALTER TABLE public.tb_mdp_va_franja_horaria OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_va_franqueo_perfil | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_va_franqueo_perfil CASCADE;
CREATE TABLE public.tb_mdp_va_franqueo_perfil (
	cod_va character varying(255),
	cod_perfil character varying(255),
	cod_franqueo character varying(255),
	fec_creacion character varying(255),
...
-- ddl-end --
ALTER TABLE public.tb_mdp_va_franqueo_perfil OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_va_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_va_idioma CASCADE;
CREATE TABLE public.tb_mdp_va_idioma (
	cod_va character varying(255),
	cod_perfil character varying(255),
	fec_alta character varying(255),
	cod_idioma_alpha2 character varying(255),
	fec_baja character varying(255),
	nom_va character varying(255),
	desc_va character varying(255),
	desc_va_ext character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_va_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_va_impuesto_gravamen | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_va_impuesto_gravamen CASCADE;
CREATE TABLE public.tb_mdp_va_impuesto_gravamen (
	cod_va character varying(255),
	cod_tasa_impositiva character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_va_impuesto_gravamen OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_va_perfil | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_va_perfil CASCADE;
CREATE TABLE public.tb_mdp_va_perfil (
	cod_va character varying(255),
	cod_perfil character varying(255),
	fec_alta character varying(255),
	fec_baja character varying(255),
	cod_sap character varying(255),
	importe_base character varying(255),
	importe_min character varying(255),
	por_incremento character varying(255),
	valor_complejidad character varying(255),
	desc_precio_va character varying(255),
	cod_formula character varying(255),
	desc_formula character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_va_perfil OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_va_restriccion | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_va_restriccion CASCADE;
CREATE TABLE public.tb_mdp_va_restriccion (
	cod_va character varying(255),
	cod_va_rest character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_va_restriccion OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_va_restriccion_idioma | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_va_restriccion_idioma CASCADE;
CREATE TABLE public.tb_mdp_va_restriccion_idioma (
	cod_va character varying(255),
	cod_va_rest character varying(255),
	cod_idioma_alpha2 character varying(255),
	desc_restriccion character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_va_restriccion_idioma OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_zona_tarif_pais | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_zona_tarif_pais CASCADE;
CREATE TABLE public.tb_mdp_zona_tarif_pais (
	cod_zona_tarif character varying(255),
	cod_pais character varying(255),
	ind_bloqueado character varying(255),
	ind_pais_origen character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_zona_tarif_pais OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_zona_tarif_postal | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_zona_tarif_postal CASCADE;
CREATE TABLE public.tb_mdp_zona_tarif_postal (
	cod_zona_tarif character varying(255),
	cod_postal_origen character varying(255),
	cod_postal_destino character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_zona_tarif_postal OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_zona_tarif_provincia | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_zona_tarif_provincia CASCADE;
CREATE TABLE public.tb_mdp_zona_tarif_provincia (
	cod_zona_tarif character varying(255),
	cod_provincia_origen character varying(255),
	cod_provincia_destino character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_zona_tarif_provincia OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_zona_tarifaria | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_zona_tarifaria CASCADE;
CREATE TABLE public.tb_mdp_zona_tarifaria (
	cod_zona_tarif character varying(255),
	nom_zona_tarif character varying(255),
	desc_zona_tarif character varying(255),
	cod_sap_destino character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)

);
-- ddl-end --
ALTER TABLE public.tb_mdp_zona_tarifaria OWNER TO app;
-- ddl-end --

-- object: public.tb_mdp_zona_tramo | type: TABLE --
-- DROP TABLE IF EXISTS public.tb_mdp_zona_tramo CASCADE;
CREATE TABLE public.tb_mdp_zona_tramo (
	cod_zona_tarif character varying(255),
	cod_tramo character varying(255),
	fec_alta character varying(255),
	fec_baja character varying(255),
	importe_tramo character varying(255),
	importe_complemento character varying(255),
	por_complemento character varying(255),
	cod_complemento character varying(255),
	fec_creacion character varying(255),
	fec_actualizacion character varying(255)
...
-- ddl-end --
ALTER TABLE public.tb_mdp_zona_tramo OWNER TO app;
-- ddl-end --
